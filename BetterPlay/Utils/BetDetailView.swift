...
struct BetDetailView: View {
    ...
    var body: some View {
        ZStack {
            ...
            ParticipateInBetView(betData: participationData, userCoins: Utils().getCoinsOfTheUser(),isShowing: $showParticipationView)
    ...
    var teamsview: some View {
        HStack(spacing: 30){
            ...
            VStack {
                ...
                Text(convertTimestampToDate(date: betDetail.bet.date, dateFormat: "dd/MM/yy"))
                    .font(.system(size: 12))
                    .bold()
                    .foregroundColor(.white)
                
                Text(convertTimestampToDate(date: betDetail.bet.date, dateFormat: "HH:mm"))
                    .font(.system(size: 12))
                    .bold()
                    .foregroundColor(.white)
            }
...
func convertTimestampToDate(date: Int, dateFormat: String) -> String {
